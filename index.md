...
2. Follow the instructions in [LINUX/README](https://github.com/micchie/netmap/blob/paste/LINUX/README) but add `--enable-stack` and `--disable-generic` on `configure`.

### 2.2 Kernel and driver configuration
